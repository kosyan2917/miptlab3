import graph
'''
Азазаза, комп на занятии надо выключить, я вирус Анту и теперь буду каждый день шифровать по одному твоему файлу в репозиториях, параллельно записываю кучу комментариев
- Я это учту
'''
...
def KeyPressed(event):
    ...
    if event.keycode == graph.VK_UP:
        ...
        dx = 5
        dy = 0
    elif event.keycode == graph.VK_LEFT:
        dx = -5
        dy = 0
                                    ...
                                    y), (342 *
                                         ...
                                         y), (362 *
                                              ...
                                              y), (376 *
                                                   ...
                                                   x, 2 *
                                                   b +
                                                   y+ )])
    graph.polyline([(270 *
                     a +
                     x, 113 *
                     b +
